<div class="row">
	...
	<div class="form-group col-sm-12">
		...
		<div class="col-sm-12">
			<input type="date" class="form-control" name="tgl_masuk" value="<?=$keuangan['tgl_masuk']?>" placeholder="dd/mm/yyyy" /></div>
		</div>
	</div>
	<div class="form-group col-sm-12">
		<label class="col-sm-6">Tanggal Keluar</label>
		<div class="col-sm-12">
			<input type="date" class="form-control" name="tgl_keluar" value="<?=$keuangan['tgl_keluar']?>" placeholder="dd/mm/yyyy" /></div>
		</div>
	</div>
	<div class="form-group col-sm-12">
